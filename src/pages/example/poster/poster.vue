<template>
  <view class="main">
    ...
    <image :src="imageSrc" class="image" mode="widthFix" />
    <canvas :style="canvasStyle" id="poster" canvas-id="poster" type="2d" />
  </view>
</template>
...
const drawInfo = {
  ...
  title:
    "推荐: 李宁卫衣男女同款套头无帽2021秋季训练系列情侣款刺绣加绒加厚长袖上衣外套官方店AWDRB76 威廉蓝-5 XXL",
  price: "￥179.00",
  linePrice: "￥155.00"
}
const createPoster = async () => {
  ...
  console.log("posterImageInfo", posterImageInfo)
  // 绘制标签
